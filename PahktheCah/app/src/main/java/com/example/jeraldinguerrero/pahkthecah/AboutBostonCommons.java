 ...
 */
public class AboutBostonCommons extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_about_bostoncommon);
    ...
    public void onClick(View v) {
        Intent nextActivity = new Intent(AboutBostonCommons.this, MapsActivity.class);
